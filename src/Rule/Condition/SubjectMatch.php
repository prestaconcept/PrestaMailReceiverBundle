...
final class SubjectMatch implements RuleConditionInterface, ComponentWithSettingsInterface, ComponentWithDescriptionInterface
{
    ...
    {
        return $this->match->matchSettings($settings, $email->getSubject());
    }

    public function describe(array $settings = []): string
    {
        return $this->descriptor->settings('rule.description.conditions.subject_match', $settings);
    }
}
