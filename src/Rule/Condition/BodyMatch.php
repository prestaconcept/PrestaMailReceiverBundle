...
final class BodyMatch implements RuleConditionInterface, ComponentWithSettingsInterface, ComponentWithDescriptionInterface
{
    ...
    {
        return $this->match->matchSettings($settings, $email->getBody());
    }

    public function describe(array $settings = []): string
    {
        return $this->descriptor->settings('rule.description.conditions.body_match', $settings);
    }
}
